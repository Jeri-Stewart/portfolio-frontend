        ...
        <div className="project-item">
          <div className="project-image-container">
            ...
            <div className="project-hover-overlay">
              ...
              <div className="project-description">
                I revolutionized the conventional
                serology testing workflow by digitizing the entire process. This
                transformative initiative involved converting a traditional
                paper-based procedure into a streamlined and efficient
                electronic system. By embracing digital automation, I accelerated the testing process, minimize errors, and established a more sustainable approach. I am in the process of elevating this innovation by transitioning it into a standalone desktop Java application. 
              </div>
            </div>
          </div>
        </div>
